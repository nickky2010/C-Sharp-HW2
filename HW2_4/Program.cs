...
namespace HW2_4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Table table = new Table("f(x)=1+cos^2(x+a)/|x^3-2b^2|", "x", "f(x)", 8, 26);
            table.PrintHead();
            table.PrintString(x1, f1);
            table.PrintString(x2, f2);
            table.PrintBottom();
            //  Для каждого объекта–функции выполняет табулирование для ряда значений аргумента. 
            //  Результат выводить в виде таблицы, в заголовке таблицы приводить вид функции.
            ...
            Table table1 = new Table(function1.ToString(), "x", "f(x)", 8, 26);
            table1.PrintHead();
            ...
            Table table2 = new Table(function2.ToString(), "x", "f(x)", 8, 26);
            table2.PrintHead();
